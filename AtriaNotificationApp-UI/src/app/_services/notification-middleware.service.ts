...
import { NotificationGeneratedService, PushSubscription } from './notification-generated.service';
...
export class NotificationMiddlewareService {
  ...
  constructor(private notificationService: NotificationGeneratedService) { }
